...
export default function CoinbaseOne() {
  return (
    <div className="bg-white min-h-screen">
      <Helmet>
        <title>Coinbase One: Zero Trading Fees & Rewards — Coinbase Clone</title>
      </Helmet>
      ...
      <section className="pt-24 pb-32 px-4 sm:px-10 bg-gradient-to-b from-[#f0f3ff] to-white">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          <div className="flex items-center gap-2 border border-blue-200 rounded-full px-4 py-1.5 mb-8 bg-blue-50/50">
             ...
             <span className="text-[13px] font-bold tracking-widest text-blue-600 uppercase">Coinbase One</span>
          </div>
            ...
            <div className="bg-[#f8f9fb] rounded-[48px] p-12 flex flex-col justify-between group hover:bg-orange-50 transition-colors duration-500">
               ...
               <div className="mt-12 bg-white rounded-3xl p-8 shadow-sm border border-orange-100">
                  ...
                  <div className="flex justify-between items-center">
                     <span className="font-bold text-orange-600">Coinbase One Rate</span>
      ...
      <section className="py-32 px-4 sm:px-10 bg-gray-50">
        <div className="max-w-4xl mx-auto">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="px-10 py-8 text-center text-lg font-bold text-blue-600 bg-blue-50/50">Coinbase One</th>
                </tr>
              </thead>
          ...
          <p className="mt-8 text-center text-sm text-gray-400 italic">
            *Zero trading fees apply to trades on the Coinbase app and website. Spread and other fees may apply.
          </p>
        </div>
      </section>
      ...
      <section className="py-32 px-4 sm:px-10">
        <div className="max-w-7xl mx-auto bg-black rounded-[60px] p-12 md:p-24 text-white flex flex-col md:flex-row items-center justify-between gap-12">
           <div className="max-w-xl">
              ...
              <p className="text-xl text-gray-400">Join the thousands of traders who are already saving with Coinbase One.</p>
           </div>
