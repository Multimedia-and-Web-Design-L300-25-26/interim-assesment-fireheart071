...
export default function DebitCard() {
  return (
    <div className="bg-[#f8f9fb] min-h-screen">
      <Helmet>
        <title>Coinbase Debit Card: Direct Crypto Spending — Coinbase Clone</title>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
              The Coinbase Debit Card lets you spend your crypto and cash instantly. No need to sell or transfer to your bank first.
            </p>
      ...
      <section className="bg-white py-32 px-4 sm:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { icon: <Wallet />, title: "Instant funding", desc: "Spend crypto or cash directly from your Coinbase balance." },
      ...
      <section className="py-32 px-4 sm:px-10 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             {[
               { step: "01", title: "Join the waitlist", desc: "Sign up in the Coinbase app and get notified when you're eligible." },
      ...
      <section className="py-32 px-4 sm:px-10">
         <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-500 mb-12 max-w-2xl mx-auto">Get the Coinbase Debit Card and start putting your crypto to use in the real world.</p>
