...
export default function PrivateClient() {
  return (
    <div className="bg-[#0a0b0d] text-white min-h-screen">
      <Helmet>
        <title>Coinbase Private Client — Coinbase Clone</title>
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "Access to Coinbase Custody, the most secure and compliant storage solution in the industry.",
      ...
      <section className="py-32 px-4 sm:px-10 border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
           ...
           <blockquote className="text-3xl md:text-4xl font-medium leading-relaxed mb-12 text-gray-300">
             "The level of service and expertise provided by the Coinbase Private Client team is unmatched. They truly understand the needs of sophisticated investors in the digital asset space."
           </blockquote>
